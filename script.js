//todo get placeholder at start of lists
...
const verbed = ["visited", "delivered", "ate", "drank", "killed", "defenestrated", "seduced", "reverse-engineered", "bought", "sold", "crashed into", "analysed", "found", "apologised to", "drove", "ordered", "fixed", "broke", "returned", "transmuted", "advertised"].sort();
const verbing = ["visiting", "delivering", "eating", "drinking", "killing", "defenestrating", "seducing", "reverse-engineering", "buying", "selling", "crashing into", "analysing", "finding", "apologising to", "driving", "ordering", "fixing", "breaking", "returning", "transmuting", "advertising"].sort();
...
const formText = "0 1 and her husband 2 have four grown-up children, who are, in birth order, 3, 4, 5 and 6.<br> On 7 8 9, 10, at about 11 pm, 12 13 was 14 15, to 16 17, and 18 19 20, who was 21 22 from 23 to 24, to 25 26.<br> Meanwhile, 27 was 28 29 30, and 31 was at 32 in 33, where she had 34 35 from 36 the barista."
